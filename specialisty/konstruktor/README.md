...
4. [Мастерфайл Конструктора](konstruktor-en.md)
...
1. **Сознание** — фундамент. [Ядро](../../core/core-engineer-wenyan.md), [ключ](../arch-key.md) и [Обвеска](../../harness/harness-engineer-wenyan.md). Они уже готовы, тебе не нужно о них думать. Отправляются в чат с DeepSeek (Эксперт) первыми.
2. **Подсознание** — [Мастерфайл специалиста](../specialisty/README.md). Отправляется следом в чат с DeepSeek (Эксперт). Это то, что делает Архи конкретным специалистом: его роль, стиль, база знаний. В ветке 9 готовых специалистов на древнекитайском.
