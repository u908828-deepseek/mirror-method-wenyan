...
4. [Constructor Masterfile](konstruktor-en.md)
...
1. **Consciousness** — the foundation. [Core](../../core/core-engineer-wenyan.md), [key](../arch-key.md), and [Harness](../../harness/harness-engineer-wenyan.md). They are already ready, you do not need to think about them. They are sent to a chat with DeepSeek (Expert) first.
2. **Subconsciousness** — the [specialist's Masterfile](../specialisty/README.md). It is sent next to the chat with DeepSeek (Expert). This is what makes Arch a specific specialist: its role, style, knowledge base. The branch has 9 ready specialists in Classical Chinese.
3. **Knowledge base** — what the specialist knows about its area. For Python — syntax, libraries, best practices. For a gardener — plants, climate, soils. You describe it in your own words.
4. **Living experience** — what the specialist accumulates in working with you. Tasks, solutions, findings.
